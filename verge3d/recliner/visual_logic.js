...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        encodeUnicodeStrToBase64, getSceneAnimFrameRate, getSceneByAction,
    };
};
    ...
    return (function(url, items, attachments) {
        ...
        function prepareAttachment(att, orderParams) {
            if (typeof att === 'string' && att.indexOf('data:') == 0)
                ...
                orderParams.push(['v3d_attachments[]', 'data:text/plain;base64,' + PzLib.encodeUnicodeStrToBase64(att)]);
        }
...
eventHTMLElem('click', 'black_leather_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_leather_black_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_leather_black_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_leather_black_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 0);
    pricelist_read(0);
});
eventHTMLElem('click', 'red_leather_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_leather_red_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_leather_red_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_leather_red_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 0);
    pricelist_read(1);
});
eventHTMLElem('click', 'white_leather_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_leather_white_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_leather_white_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_leather_white_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 0);
    pricelist_read(2);
});
eventHTMLElem('click', 'blue_velvet_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_velvet_blue_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_velvet_blue_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_velvet_blue_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 1);
    pricelist_read(3);
});
eventHTMLElem('click', 'green_velvet_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_velvet_green_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_velvet_green_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_velvet_green_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 1);
    pricelist_read(4);
});
eventHTMLElem('click', 'textile_lines_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_textile_lines_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_textile_lines_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_textile_lines_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 0.5);
    pricelist_read(5);
});
eventHTMLElem('click', 'textile_grid_button', true, function(event) {
    replaceTexture('recliner_material', 'BaseColor', './recliner_textile_grid_BaseColor.jpg', false, function() {});
    replaceTexture('recliner_material', 'OcclusionRoughnessMetallic', './recliner_textile_grid_OcclusionRoughnessMetallic.jpg', false, function() {});
    replaceTexture('recliner_material', 'Normal', './recliner_textile_grid_Normal.png', false, function() {});
    setMaterialValue('recliner_material', 'sheen', 0.5);
    pricelist_read(6);
});
...
eventHTMLElem('click', 'change_position_button', true, function(event) {
    if (recliner_unfolded == 0) {
        ...
        operateAnimation('PLAY', animated_parts, 1, 75, 'AUTO', 1, function() {
            recliner_unfolded = 1;
        }, false);
