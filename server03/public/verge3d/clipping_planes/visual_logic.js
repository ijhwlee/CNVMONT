...
registerOnDrag('minus', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('ClippingPlane', 'X', 'WORLD', 'A+x|=B1LVP({d`u3zd/K', ',M}aOcHprePY@Mj@wWx/');
    dragMoveAdv('minus', 'X', 'WORLD', 'fBF(9DRX/(We~:h70.ST', ',M}aOcHprePY@Mj@wWx/');
    dragMoveAdv('plus', 'X', 'WORLD', 'TzMiLIZ4-0o(DjbeHAp8', ',M}aOcHprePY@Mj@wWx/');
}, function(event) {}, ',M}aOcHprePY@Mj@wWx/');

registerOnDrag('plus', false, [0,1,2], function(event) {}, function(event) {
    dragMoveAdv('ClippingPlane', 'X', 'WORLD', '*^Iy+Sa;|8mpys`r=YFu', ';pN@4_degJ5]+!bs~3c7');
    dragMoveAdv('minus', 'X', 'WORLD', ',bLWHpLG}%_VQR=?u?EU', ';pN@4_degJ5]+!bs~3c7');
    dragMoveAdv('plus', 'X', 'WORLD', 'bcAkPOJu,ig:{#sy!G^g', ';pN@4_degJ5]+!bs~3c7');
