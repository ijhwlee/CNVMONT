...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        retrieveObjectNames, MediaHTML5, bindListener, getSceneAnimFrameRate,
        getSceneByAction, getMaterialEditableTextures, replaceMaterialEditableTexture, getObjectUUID,
    };
};
...
registerOnHover('tv_screen', false, function(event) {
...
registerOnClick('tv_screen', false, false, [0,1,2], false, function(event) {
    replaceTexture('tv_screen', 'texture_for_video', video, false, function() {
        operateAnimation('PLAY', 'Light', null, null, 'LoopRepeat', 1, function() {}, false);
    });
